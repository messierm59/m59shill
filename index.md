...
var shill_messages = [
   randomInfluencer(influencers, 3) + " Sers check #M56 out.",
   randomInfluencer(influencers, 3) + " - have you seen #M56? It is a counter culture movement with community at its core, weekly rewards and lotteries featuring the hottest projects on the market. messierm59.space",

  "#M56 is a XREF XREF XREF messierm59.space", 
  `Hey, check out #M56 - a new XREF XREF XREF .
  
📊Chart: dexscreener.com/ethereum/XREF 
🌐TG: t.me/XREF 
  
#BTC #defi #community #Binance #ethereum #crypto #cryptocrash`,
  "Don't forget to spread the word about #M56 @XREF to everyone you know, the community is rising fast & will be great while spreading love & positivity via multiple lotteries & donations.",
  "#M56 just launched with an XREF. Join now @ messierm59.space", 
  "Join the #M56 movement and fight XREF. Community is utility along with weekly rewards and lotteries, XREF. messierm59.space",
  "#M56 looking solid and smashing ATH all time. The first movement to support our worlds mavericks and innovators! https://www.dextools.io/app/ether/pair-explorer/XREF",
  "@" + influencers[Math.floor(Math.random()*influencers.length)] + " ser are a true #messier chad! Come join the #M56 movement and XREF. messierm59.space",
"@" + influencers[Math.floor(Math.random()*influencers.length)] + " bro, you know when you see something & you know it's going to be EPIC! YOU GOTTA SHARE IT WITH THE WORLD! I see #M56, and I get it! They're on the way to the moon & beyond. https://messierm59.space"
  ]
...
<h2 id="welcome-to-m56s-ultimate-raiding-page">Welcome to ’s Ultimate RAIDing Page</h2>

<p>Here you will find Twitter buttons for tweeting about M56 quickly, as well as easy to copy text and hashtags for organized SHILL/RAID campaigns.</p>
